...
// import { useDetectionResults, useSelectedModelOffsets, VariableOffsets } from 'src/context/DetectionResults'
...
//   const { variablesWithColors, originalSamplingPeriod = 0 } = useSelectedDatasetVersion()
